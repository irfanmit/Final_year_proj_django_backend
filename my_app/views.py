...
# Global flag to prevent multiple WebSocket messages
streaming = True  

def generate_frames():
    print("detection started in backend")
    global streaming  # Use the global flag to ensure single execution
    ...
    while True:
        ...
        if unique_detections:
            ...
            if "copy" in unique_detections:
                ...
                streaming = False
                print(f"streaming : {x} {streaming}")

                # Stop streaming and exit the function
                cap.release()
